...
func TestLoadProfileHysteria2(t *testing.T) {
	...
	profile := `{"log":{"loglevel":"warning"},"inbounds":[],"outbounds":[
		{"tag":"proxy-1","protocol":"hysteria","settings":{"version":2,"address":"dash.netbridge.app","port":29347},
		 "streamSettings":{"network":"hysteria","security":"tls",
		   "tlsSettings":{"serverName":"dash.netbridge.app","allowInsecure":false},
	...
	if dp.Address != "dash.netbridge.app" || dp.Port != 29347 {
		t.Errorf("address/port = %s/%d", dp.Address, dp.Port)
	}
	if dp.SNI != "dash.netbridge.app" || dp.Security != "tls" {
